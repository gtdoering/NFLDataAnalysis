...
```
This chunk of code creates a ggplot for the 2020 season based off the amount of offense 
that a team compiled. The size of the point corresponds to the amount of wins that the
team got in the 2020 season. The label includes the misery score for the team based off
their rushing and passing yards combined. The color of the point is also the team color.
